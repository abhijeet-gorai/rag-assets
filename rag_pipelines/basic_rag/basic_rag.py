...
class BasicRAG:
    ...
    This class integrates document retrieval with a language model to answer queries based on 
    retrieved relevant documents.
    """

    def __init__(self, config:AppConfig = {}) -> None:
        """
        Initializes the BasicRAG system by setting up the language model and the vector database.
    ...
    def add_documents(self, file_list: List[str]) -> None:
        """
        Reads and processes documents from the given file paths, then adds them to the vector database.
