...
class ChatWithImage:
    ...
    def __init__(
        ...
        groq_apikey: Optional[str] = os.getenv("GROQ_APIKEY")
    ) -> None:
        """
        Initialize the ChatWithImage instance.

        :param model_id: The model ID to be used.
        :param decoding_method: The decoding method.
        :param max_tokens: Maximum tokens for the response.
        :param min_new_tokens: Minimum new tokens for the response.
        :param temperature: Temperature for generation.
        :param top_k: Top-k sampling value.
        :param top_p: Top-p sampling value.
        :param repetition_penalty: Repetition penalty.
        :param stop_sequences: List of stop sequences.
        :param groq_apikey: API key for GROQ.
        :raises ValueError: If GROQ_APIKEY is missing.
        """
        if stop_sequences is None:
            stop_sequences = []
        if not groq_apikey:
            raise ValueError(
                "GROQ_APIKEY is required for GROQ. "
